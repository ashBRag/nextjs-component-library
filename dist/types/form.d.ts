...
interface FormValidationResult<T extends Record<string, any>> {
    isValid: boolean;
    errors: FormErrors<T>;
    warnings?: string[];
}
...
interface UseFormWithToastConfig<T extends Record<string, any>> extends UseFormConfig<T> {
    toast?: ToastMethods;
    successMessage?: string;
    errorMessage?: string;
}

export type { FieldProps, FormErrors, FormValidationResult, SubmissionResult, ToastMethods, UseFormConfig, UseFormReturn, UseFormWithToastConfig, ValidationRule, ValidationRules };
