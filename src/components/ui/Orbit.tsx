    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="relative">
        ...
        {/* Central profile block */}
            ...
            {profileImage ? (
              <Image src={profileImage} alt="Profile" className="object-cover rounded-xl" width={120} height={120} />
            ) : (
              <div className={`w-full h-full bg-gradient-to-br ${bgColor} rounded-xl flex items-center justify-center text-white text-2xl font-bold`}>
                {profileText}
              </div>
            )}
